...
"use strict";function Maker(e){this.apiKey=e.apiKey||"",this.apiSecret=e.apiSecret||"",this.apiUrl=e.apiUrl||"https://stg.surbtc.com/api/v1",this.bridgeCurrency=e.bridgeCurrency||"BTC",this.sourceCurrencyDepositFee=e.sourceCurrencyDepositFee||0,this.destinationCurrencyWithdrawalFee=e.destinationCurrencyWithdrawalFee||.004,this.destinationCurrencyWithdrawalFixedFee=e.destinationCurrencyWithdrawalFixedFee||5500,this.dinexFee=0===e.dinexFee?0:e.dinexFee||.02,this.btcInsurance=e.btcInsurance||.015}var async=require("async"),_=require("lodash");require("bitcoin-math");var SurbtcRestClient=require("surbtc-rest-client");Maker.prototype._calculateQuotationFixedSource=function(e,t){var n=this,r=e.sourceAmount/((1-n.dinexFee)*(1-n.sourceCurrencyDepositFee)),o=_.toNumber(e.quotation.quote_balance_change[0]),u=o*(1-n.destinationCurrencyWithdrawalFee)-n.destinationCurrencyWithdrawalFixedFee,i=o/e.sourceAmount,a=r*n.sourceCurrencyDepositFee,s=(r-a)*n.dinexFee,c=_.toNumber(e.reverseQuotation.order_amount[0]),d={quotation:e.quotation,reverseQuotation:e.reverseQuotation,marketExchangeRate:i,sourceAmount:e.sourceAmount,sourceCurrency:e.sourceCurrency,sourceCurrencyDepositFeeAmount:a,dinexFeeTotalAmount:_.round(s),sourceAmountToBeDeposited:_.round(r),destinationCurrency:e.destinationCurrency,destinationAmountNoFees:o,destinationAmountToBeReceived:_.round(u,2),btcToBuy:c,maxSourceAmount:e.dinexBalance>=_.toNumber(e.sourceAmount)?!1:_.round(e.dinexBalance)};return t(null,{success:!0,quotation:d})},Maker.prototype._calculateQuotationFixedDestination=function(e,t){var n=this,r=-1*_.toNumber(e.quotation.quote_balance_change[0]),o=e.reverseQuotation.quote_balance_change[0],u=e.destinationAmount*(1-n.destinationCurrencyWithdrawalFee)-n.destinationCurrencyWithdrawalFixedFee,i=o/r,a=r/(1-n.sourceCurrencyDepositFee),s=a/(1-n.dinexFee),c=_.toInteger(s-a),d=_.toInteger(a-r),l=_.toNumber(e.reverseQuotation.order_amount[0]),m={quotation:e.quotation,reverseQuotation:e.reverseQuotation,marketExchangeRate:i,sourceAmount:r,sourceCurrency:e.sourceCurrency,sourceCurrencyDepositFeeAmount:d,sourceAmountPlusDepositFee:a,dinexFeeTotalAmount:_.round(c),sourceAmountToBeDeposited:_.round(s),destinationCurrency:e.destinationCurrency,destinationAmountNoFees:o,destinationAmountToBeReceived:_.round(u,2),btcToBuy:l,maxSourceAmount:e.dinexBalance>=_.round(r)?!1:_.round(e.dinexBalance)};return t(null,{success:!0,quotation:m})},Maker.prototype.quoteRemittanceFixedSource=function(e,t){var n=this,r=new SurbtcRestClient({api:n.apiUrl,secret:n.apiSecret,key:n.apiKey});if(!e.sourceCurrency)return t({success:!1,error_type:"sourceCurrency_required",statusCode:400},null);if(!e.sourceAmount||!_.isFinite(e.sourceAmount))return t({success:!1,error_type:"sourceAmount_invalid",statusCode:400},null);if("CLP"!==e.sourceCurrency)return t({success:!1,error_type:"sourceCurrency_invalid",statusCode:400},null);var o="BTC-CLP",u="Bid",i="BTC-COP",a="Ask";e.sourceAmount=_.toInteger(e.sourceAmount)*(1-n.sourceCurrencyDepositFee)*(1-n.dinexFee),e.destinationCurrency="COP",async.waterfall([function(t){r.getBalances(e.sourceCurrency,t)},function(t,n){e.dinexBalance=t?t.balance.available_amount/100:1,r.getReverseQuotation(o,u,e.sourceAmount,n)},function(t,o){e.reverseQuotation=t.quotation,e.reverseQuotationAmountPlusInsurance=_.toNumber(e.reverseQuotation.base_balance_change[0])*(1-n.btcInsurance),r.getQuotation(i,a,e.reverseQuotationAmountPlusInsurance,o)},function(t,r){e.quotation=t.quotation,n._calculateQuotationFixedSource(e,r)}],t)},Maker.prototype.quoteRemittanceFixedDestination=function(e,t){var n=this,r=new SurbtcRestClient({api:n.apiUrl,secret:n.apiSecret,key:n.apiKey});if(!e.destinationCurrency)return t({success:!1,error_type:"destinationCurrency_required",statusCode:400},null);if(!e.destinationAmount||!_.isFinite(e.destinationAmount))return t({success:!1,error_type:"destinationAmount_invalid",statusCode:400},null);if("COP"!==e.destinationCurrency)return t({success:!1,error_type:"destinationCurrency_invalid",statusCode:400},null);var o="BTC-COP",u="Ask",i="BTC-CLP",a="Bid";e.destinationAmount=_.toNumber(e.destinationAmount),e.destinationAmount=e.destinationAmount/(1-n.destinationCurrencyWithdrawalFee),e.sourceCurrency="CLP",async.waterfall([function(t){r.getReverseQuotation(o,u,e.destinationAmount,t)},function(t,o){e.reverseQuotation=t.quotation,e.reverseQuotationAmountPlusInsurance=_.toNumber(e.reverseQuotation.base_balance_change[0])/(n.btcInsurance-1),r.getQuotation(i,a,e.reverseQuotationAmountPlusInsurance,o)},function(t,n){e.quotation=t.quotation,r.getBalances(e.sourceCurrency,n)},function(t,r){e.dinexBalance=t.balance.available_amount/100,n._calculateQuotationFixedDestination(e,r)}],t)},Maker.prototype._getBalance=function(e,t,n,r){var o=this,u=new SurbtcRestClient({api:o.apiUrl,secret:o.apiSecret,key:o.apiKey});u.getBalances(e,function(o,u){return o?n(o,null):void(_.toNumber(u.balance.available_amount)>=_.toNumber(t)?n(null,u):setTimeout(function(){r(e,t,n,r)},500))})},Maker.prototype._pollBalance=function(e,t,n){var r=this;r._getBalance(e,t,n,r._getBalance.bind(this))},Maker.prototype.executeRemittance=function(e,t){var n=this,r=new SurbtcRestClient({api:n.apiUrl,secret:n.apiSecret,key:n.apiKey});if(!e.btcAmount||!_.isFinite(e.btcAmount))return t({success:!1,error_type:"btcAmount_invalid",statusCode:400},null);if(!e.destinationCurrency)return t({success:!1,error_type:"destinationCurrency_required",statusCode:400},null);if("COP"!==e.destinationCurrency)return t({success:!1,error_type:"destinationCurrency_invalid",statusCode:400},null);var o=e.btcAmount.toSatoshi(),u={type:"bid",limit:null,amount:o,price_type:"market"},i={type:"ask",limit:null,amount:null,price_type:"market"};async.waterfall([function(n){r.getQuotation("btc-clp","bid",e.btcAmount,function(e,o){return e?t({success:!1,error:e,statusCode:500},null):void r.getBalances("clp",function(e,r){return e?t({success:!1,error:e,statusCode:500},null):r.balance.available_amount/100>-1*o.quotation.quote_balance_change[0]?void n():t({success:!1,error:"insufficient CLP balance on Dinex master account",statusCode:400},null)})})},function(e){r.createAndTradeOrder("btc-clp",u,function(n,r){return n?t({success:!1,error:n,statusCode:500},null):(i.amount=_.toNumber(r.order.traded_amount)-_.toNumber(r.order.paid_fee),u.tradedOrder=r.order,e(),void 0)})},function(e){n._pollBalance("btc",i.amount,function(e,n){e?t({success:!1,error:e,statusCode:500},null):r.createAndTradeOrder("btc-cop",i,function(e,n){e?t({success:!1,error:e,statusCode:500},null):(i.tradedOrder=n.order,t(null,{success:!0,buyOrder:u,sellOrder:i,statusCode:200}))})})}],t)},module.exports=Maker,module.exports.surBtcRestClient=SurbtcRestClient;
